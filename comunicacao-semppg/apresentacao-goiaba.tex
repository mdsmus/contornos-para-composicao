...
\frame{
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=.7]{5a-sinfonia}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=.8]{c-3120}
...
\frame{
  ...
  \begin{itemize}
  \item Objetivo do software \goiaba{}: processar operações com
    contornos musicais
  \item Justificativas:
    \begin{itemize}
    \item contornos ajudam a dar coerência a uma obra musical

      \cite{clifford95:contour}
    \item contornos podem ser manipulados através de operações como
      inversão e retrogradação
    \item um software para processamento de contornos pode efetuar os
      cálculos matemáticos das operações de contorno com rapidez e
      precisão nos resultados e pode plotar contornos
    \end{itemize}
  \end{itemize}
}
