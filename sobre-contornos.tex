...
semelhante. Friedmann \cite{friedmann:contour} discute a respeito das
ferramentas criadas por Marvin e Laprade \cite{marvin.ea:relating},
Morris \cite{morris:composition} e ele próprio
\cite{friedmann:contour}.

\bibliography{contorno}
