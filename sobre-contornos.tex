...
notas, podem ajudar com a coerência musical de uma obra. Para uma
efetividade artística, a coerência e continuidade musical---princípios
que podem operar em vários níveis---não podem estar limitadas à
repetição de elementos, mas devem existir em um contexto em que estes
elementos sejam de alguma maneira diferenciados
\cite[p. 296]{kliewer75:aspects}.
