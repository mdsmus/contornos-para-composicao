...
\ref{fig:c-space} contém um \termo{c-space} com 10 \termo{c-pitch}
enumerados do mais grave (0) para o mais agudo (9). O \termo{c-space}
representado contém dois \termo{cseg}: P, com os \termo{c-pitch} 5, 9,
6 e 8, e M, com 7, 4, 2 e 0. O \termo{cseg} M contém um
\termo{csubseg} N com os \termo{c-pitch} 4 e 2.

\begin{figure}
  \centering
  \includegraphics{cspace}
  \caption{C-space com csegs P e M, e csubseg N}
  \label{fig:c-space}
\end{figure}
